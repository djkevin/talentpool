	...
	<body>
		...
		<div id="show-document" class="content scaffold-show" role="main">
			...
			<ol class="property-list document">
				...
				<g:if test="${documentInstance?.documentType}">
				<li class="fieldcontain">
					<span id="documentType-label" class="property-label"><g:message code="document.documentType.label" default="Document Type" /></span>
					
						<span class="property-value" aria-labelledby="documentType-label"><g:fieldValue bean="${documentInstance}" field="documentType"/></span>
				...
				<g:if test="${documentInstance?.person}">
				<li class="fieldcontain">
					<span id="person-label" class="property-label"><g:message code="document.person.label" default="Person" /></span>
					
						<span class="property-value" aria-labelledby="person-label"><g:link controller="person" action="show" id="${documentInstance?.person?.id}">${documentInstance?.person?.encodeAsHTML()}</g:link></span>
